                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div id="casilla" style="text-align: center;">
                                    ...
                                    <div style="text-align: left;">
                                        <label   >Solicitante: &nbsp;</label><label  style="font-weight: 300;" ><?php echo $notificacion->Nombre.' '.$notificacion->Apellido; ?></label>
                                    </div>
                                    <div style="text-align: left;">
                                        <label   >Teléfono: &nbsp;</label><label  style="font-weight: 300;" ><?php echo $notificacion->telefono; ?></label>
                                    </div>
                                    <div style="text-align: left;">
                                        <label   >Institución: &nbsp;</label><label  style="font-weight: 300;" ><?php echo $notificacion->NombreUniversidad; ?></label>
                                    </div>
                                    ...
                                    <div style="text-align: left;">
                                        <label   >Presupuesto Enviado Bs: &nbsp;</label><label  style="font-weight: 300;" ><?php echo $notificacion->montoBs; ?></label>
                                    </div>
                                    <div style="text-align: left;">
