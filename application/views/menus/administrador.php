...
<script type="text/javascript" language="javascript">
		...
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200){
                    ...
                    $.each(json.results[0][1].notificaciones, function(i, result){//border-bottom: 1px dotted #CCC;cursor:pointer;
                        ...
                        var div3= document.createElement('div');
                            $(div3).html('<label  style="font-weight: 700;cursor:pointer;" >Cantidad:</label> <label  style="font-weight: 300;cursor:pointer;" >'+result['cantidad']+'</label>');
		...
		refreshDivs('recargado',10,'<?= base_url() ?>productos/ajax_notificaciones');
                
		}
		</script>
<ul id="css3menu1" class="topmenu">
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	
	<li class="topmenu"><a href="<?= base_url() ?>administrador" style="line-height:24px;"><img src="<?= base_url() ?>/img/aqua_1_022.png" alt="Home"/>Inicio</a></li>
	<li class="topmenu"><a href="<?= base_url() ?>administrador/nosotros" style="line-height:24px;"><span><img src="<?= base_url() ?>/img/aqua_1_01.png" alt="Overview"/>Nosotros</span></a></li>
	<li class="topmenu"><a style="line-height:24px;" href="#" title="Productos y Servicios"><img src="<?= base_url() ?>/img/aqua_1_022.png" alt="What's New"/>Productos</a>
        <ul>
		<li><a href="<?= base_url() ?>productos/anillos"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Core Templates"/>Anillos de Graduaci&oacute;n</a></li>
		<li><a href="<?= base_url() ?>productos/medallas"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Current Templates"/>Medallas</a></li>
