...
<script type="text/javascript" language="javascript">
		...
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200){
                    ...
                    $.each(json.results[0][2].ntf_s_presupuesto, function(i, result){//border-bottom: 1px dotted #CCC;cursor:pointer;
                        var a1= document.createElement('a');
                        $(a1).attr('href','<?= base_url() ?>productos_clientes/ver_presupuesto_paquetes/'+result['idsolicitud_presupuesto']);
                        $(a1).attr('style', 'border-bottom: 4px dotted #fff;margin-bottom:10px;box-shadow: 0px 1px 2px #695E5E;text-align: center;');
                        var div1= document.createElement('div');
                            $(div1).attr('style', 'width:100%; word-wrap: break-word;white-space: initial;');
                        var div2= document.createElement('div');
                    ...
                    $.each(json.results[0][3].ntf_cotizacion, function(i, result){//border-bottom: 1px dotted #CCC;cursor:pointer;
                        var a1= document.createElement('a');
                        $(a1).attr('href','<?= base_url() ?>productos_clientes/ver_detalle_cotizacion/'+result['idcotizacion']);
                        $(a1).attr('style', 'border-bottom: 4px dotted #fff;margin-bottom:10px;box-shadow: 0px 1px 2px #695E5E;text-align: center;');
                        var div1= document.createElement('div');
                            $(div1).attr('style', 'width:100%; word-wrap: break-word;white-space: initial;');
                        var div2= document.createElement('div');
                            $(div2).html('<label  style="font-weight: 700;cursor:pointer;" >Cotizacion Recibida Bs:</label></br><label  style="font-weight: 300;cursor:pointer;" >'+result['bs']+'</label>');
                        var div3= document.createElement('div');
...
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	
	...
	<li class="topmenu"><a style="line-height:24px;"  title="Productos y Servicios"><img src="<?= base_url() ?>/img/aqua_1_022.png" alt="What's New"/>Productos</a>
        <ul>
                <li><a href="<?= base_url() ?>productos_clientes/cotizacion"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Core Templates"/>Cotización</a></li>
		...
		<li><a href="<?= base_url() ?>productos_clientes/portaTitulos"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Enterprise Templates"/>Porta T&iacute;tulo</a></li>
                ...
                <li><a href="<?= base_url() ?>productos_clientes/catalogo"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Enterprise Templates"/>Catálogo</a></li>
	</ul></li>
	<li class="topmenu"><a href="#" style="line-height:24px;"><span><img src="<?= base_url() ?>/img/aqua_1_46.png" alt="Samples"/>Cliente</span></a>
            <ul>
                    
                    <li><a href="#"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Current Templates"/>Registrar</a>
                        <ul id="submenu" >
                            <li><a href="#"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Core Templates"/>Pago</a>
                            <li><a href="#"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Core Templates"/>Imprimir Contrato</a>
                        </ul>
                    </li>
                    <li><a href="#"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Core Templates"/>Cronograma</a></li>
                    <li><a href="#"><img src="<?= base_url() ?>/img/aqua_1_50.png" alt="Current Templates"/>Galer&iacute;as</a></li>
